...
//
//     // No test device configuration is required in production
//     runApp(MyApp());
//   });
// }
//
...
//   void loadBannerAd() {
//     _bannerAd = BannerAd(
//       adUnitId: 'ca-app-pub-2568606411679432/9171074781', // Real Ad Unit ID for production
//       size: AdSize.banner,
//       request: AdRequest(),
  ...
  MobileAds.instance.initialize().then((InitializationStatus status) {
    ...
    MobileAds.instance.updateRequestConfiguration(
        RequestConfiguration(testDeviceIds: ['a5d416b8-54f1-4b94-8236-10ca1ad1abe1',
          "105b1fa8-bbb4-4224-8c61-10ca1ad1abe1"
        ])
    );
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void loadBannerAd() {
    _bannerAd = BannerAd(
      adUnitId: 'ca-app-pub-2568606411679432/9171074781', // Test Ad Unit ID
      size: AdSize.banner,
      request: AdRequest(),
      listener: BannerAdListener(
        onAdLoaded: (Ad ad) {
